...
import {Alert, Text, View, SafeAreaView, FlatList, Image, ImageBackground, Dimensions, StatusBar, StyleSheet} from "react-native";
...
export default class MeteorScreen extends Component{
    ...
    getMeteors = () => {
        axios
             .get("https://api.nasa.gov/neo/rest/v1/feed?api_key=gRsH9ySDkr2gVQjlpSJI3SEyym60hyQWXsMhRbTa")
             .then(response=> {
                this.setState({
